...
FILES = [
    ...
    ('libgpod-0.8.3.tar.bz2', 'f8a0b7a34e768e33a708e8dd172bd6f8'),
    ...
    ('libmtp-1.1.12.tar.gz', '0c59559ea253d02170511ecf6b05d577'),
    ...
    ('libsoup-2.56.0.tar.xz', '465083f74b7bb035959ddb0599313986'),
    ...
    ('libxml2-2.9.4.tar.gz', 'ae249165c173b1ff386ee8ad676815f5'),
    ('nettle-3.3.tar.gz', '10f969f78a463704ae73529978148dbe'),
    ('openssl-1.0.2j.tar.gz', '96322138f0b69e61b7212bc53d5e912b'),
    ('opus-1.1.3.tar.gz', '32bbb6b557fe1b6066adc0ae1f08b629'),
    ('orc-0.4.26.tar.xz', '8e9bef677bae289d3324d81c337a4507'),
    ('protobuf-2.6.1.tar.gz', 'f3916ce13b7fcb3072a1fa8cf02b2423'),
    ('pthreads-w32-2-9-1.tar.gz', '0fd88dc15fa4f284598f1d3942fe3cee'),
    ...
    ('speex-1.2rc2.tar.gz', '6ae7db3bab01e1d4b86bacfa8ca33e81'),
